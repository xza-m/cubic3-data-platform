...
describe('OntologyWorkbench page', () => {
  ...
  it('支持语义权限建模', async () => {
    ...
    expect(await screen.findByText('治理影响总览')).toBeInTheDocument()
    expect(await screen.findByText('关联分析实体')).toBeInTheDocument()
    expect(await screen.findByText('治理挂点状态')).toBeInTheDocument()
