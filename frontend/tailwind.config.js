  ...
  theme: {
  	...
  	extend: {
  		...
  		boxShadow: {
  			...
  			secondary: '0 10px 15px -3px rgba(16, 185, 129, 0.2), 0 4px 6px -2px rgba(16, 185, 129, 0.1)',
  			accent: '0 10px 15px -3px rgba(245, 158, 11, 0.2), 0 4px 6px -2px rgba(245, 158, 11, 0.1)'
  		},
  		spacing: {
  			'18': '4.5rem',
  			'88': '22rem'
