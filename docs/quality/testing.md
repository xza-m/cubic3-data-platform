...
cd frontend && npm run test:unit -- src/v2/api/semantic-field-candidates.test.ts src/v2/pages/semantic/cubes/CubeCreate.test.tsx src/v2/pages/semantic/modeling-copilot/ModelingAgent.test.tsx
