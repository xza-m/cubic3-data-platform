...
| 包管理与脚本 | `pnpm`、`npm run test`、Vite 默认 `5173` | 当前使用 `npm`、脚本为 `test:unit` / `test:e2e` / `verify:*`，端口为 `3000` | 已重写前端文档与启动文档 |
...
1. `README.md`
2. `docs/TECH_STACK_AND_ARCHITECTURE.md`
3. `docs/QUICK_START.md`
4. `docs/STARTUP_GUIDE.md`
...
- `docs/FRONTEND_ARCHITECTURE_REVIEW.md`
- `docs/FRONTEND_FIX_SUMMARY.md`
- `docs/METADATA_SYNC_GUIDE.md`
- `docs/METADATA_SYNC_QUICKSTART.md`
- `docs/METADATA_SYNC_FRONTEND.md`
