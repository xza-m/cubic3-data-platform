...
- [ ] 修改 [tests/integration/test_openapi_docs.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/tests/integration/test_openapi_docs.py)，删除 `CONTRACT_REQUIRED_OPERATIONS` 中对 `/api/v1/query-execution/jobs` 和 `/api/v1/query-execution/jobs/{job_id}` 的期望。
...
- [ ] 修改 [frontend/src/v2/pages/config/access/AccessIdentity.tsx](/Users/xuan/Work/cursor_projects/cubic3-data-platform/frontend/src/v2/pages/config/access/AccessIdentity.tsx)，先提取可测试函数：
...
- [ ] 修改 [app/interfaces/api/v1/queries.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/v1/queries.py)，删除以下 gateway 专用逻辑：
...
- [ ] 更新或删除 [tests/integration/access/test_gateway_query_execution_api.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/tests/integration/access/test_gateway_query_execution_api.py)。该文件不再验证 query console 走 gateway；对应 gateway 执行测试迁移到 Agent 语义执行测试。
- [ ] 运行：

```bash
pytest tests/integration/query/test_query_console_datasource_spi_api.py tests/integration/access/test_gateway_query_execution_api.py -q
```
...
- [ ] 在 [app/infrastructure/adapters/datasources/base_adapter.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/infrastructure/adapters/datasources/base_adapter.py) 的 `DataSourceAdapter.execute_query` 附近补充中文注释：
...
- [ ] 更新 [docs/architecture/decisions/ADR-011-dw-query-gateway-execution-boundary.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/architecture/decisions/ADR-011-dw-query-gateway-execution-boundary.md)，确认 DataSource Adapter SPI 和 gateway 的责任边界与代码实现一致。
...
- [ ] 检查 [app/interfaces/api/v1/governance.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/v1/governance.py)，保留：
  - 访问策略。
  - 身份绑定。
  - 执行 profile。
...
- [ ] 修改 [app/interfaces/api/v1/agent.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/v1/agent.py)，从新文件导入 `AgentSemanticExecuteRequest`。
...
- [ ] 修改 [app/di/container.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/di/container.py)：
...
- [ ] 修改 [app/interfaces/api/v1/agent.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/v1/agent.py)，从 container 获取新服务：
...
- [ ] 修改 [app/__init__.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/__init__.py)：
...
- [ ] 修改 [tests/conftest.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/tests/conftest.py)，删除 query execution ORM model import 和 fixture 依赖。
- [ ] 修改 [app/interfaces/api/openapi_metadata.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/openapi_metadata.py)，删除 `query-execution` tags、operation metadata 和 required operation。
- [ ] 修改 [Makefile](/Users/xuan/Work/cursor_projects/cubic3-data-platform/Makefile)，删除 `test-query-execution` 目标，并从 `verify-semantic` 或其他聚合目标中移除该依赖。
- [ ] 修改 [scripts/checks/agent_runtime_live_acceptance.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/scripts/checks/agent_runtime_live_acceptance.py)，删除对 `QueryExecutionWorkerService`、`/api/v1/query-execution/*` 的 live acceptance 依赖；保留 agent runtime 自身 smoke。
...
- [ ] 修改 [scripts/checks/semantic_alembic_baseline.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/scripts/checks/semantic_alembic_baseline.py)，从最终基线表集合中移除 `query_execution_jobs`、`query_execution_events`、`query_result_objects`。
- [ ] 如 [tests/unit/scripts/test_alembic_initial_schema_contract.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/tests/unit/scripts/test_alembic_initial_schema_contract.py) 静态断言 `0001_initial_schema.py` 中包含 query execution 表，移除该断言；不回写历史初始迁移。
- [ ] 运行：
...
- [ ] 修改 [frontend/src/v2/pages/config/access/AccessIdentity.tsx](/Users/xuan/Work/cursor_projects/cubic3-data-platform/frontend/src/v2/pages/config/access/AccessIdentity.tsx)：
...
- [ ] 修改 [app/infrastructure/gateway/telemetry_client.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/infrastructure/gateway/telemetry_client.py)，将 gateway 原始响应规范化为控制面展示模型，至少包含：
  - `queued_count`
  - `running_count`
  - `pending_count`
  - `avg_queue_wait_ms`
  ...
  - `spool_object_count`
  - `generated_at`
- [ ] 修改 [app/interfaces/api/v1/governance.py](/Users/xuan/Work/cursor_projects/cubic3-data-platform/app/interfaces/api/v1/governance.py) 的 `/api/v1/governance/gateway/summary`，只做 BFF 代理和字段规整，不自行计算执行事实。
- [ ] 新增或更新测试：
...
- [ ] 检查 [openspec/changes/integrate-gateway-query-execution/proposal.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/openspec/changes/integrate-gateway-query-execution/proposal.md)、[openspec/changes/integrate-gateway-query-execution/design.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/openspec/changes/integrate-gateway-query-execution/design.md) 和 [openspec/changes/integrate-gateway-query-execution/tasks.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/openspec/changes/integrate-gateway-query-execution/tasks.md)，将 active proposal 改为“gateway 边界收敛与 query_execution 下线”或归档到 superseded 状态。
...
- [ ] 更新 [README.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/README.md)，查询能力描述改为：
  - 查询工作台/SQL Lab：DataSource Adapter SPI。
  - 正式受治理数仓查询：dw-query-gateway。
  - 本仓不再内置 `query_execution`。
- [ ] 更新 [docs/TECH_STACK_AND_ARCHITECTURE.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/TECH_STACK_AND_ARCHITECTURE.md)，删除 `query_execution` worker 和表结构描述。
- [ ] 更新 [docs/architecture/README.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/architecture/README.md)，把 ADR-011 标为当前边界基线。
- [ ] 更新 [docs/DOC_ALIGNMENT_REPORT.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/DOC_ALIGNMENT_REPORT.md)，确认 ADR-011、Tech Stack、README 已对齐。
- [ ] 更新 [docs/quality/testing.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/quality/testing.md)，删除 `make test-query-execution`，增加 gateway boundary 验证入口。
- [ ] 更新 [docs/semantic_verification.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/semantic_verification.md)，语义执行验收改为 gateway 提交，不再验证本仓 job。
- [ ] 更新 [docs/QUICK_START.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/QUICK_START.md)、[docs/STARTUP_GUIDE.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/STARTUP_GUIDE.md)、[docs/runbooks/local-dev.md](/Users/xuan/Work/cursor_projects/cubic3-data-platform/docs/runbooks/local-dev.md)，删除 query execution worker 启动说明。
- [ ] 运行：
