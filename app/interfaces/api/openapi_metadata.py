...
AGENT_EXECUTE_RESPONSE_SCHEMA = object_schema(
    {
        ...
        "semantic_plan_id": {"type": ["string", "null"], "description": "语义规划 ID"},
        "gateway_query_id": {"type": ["string", "null"], "description": "dw-query-gateway 查询 ID"},
        "gateway": {"type": ["object", "null"], "additionalProperties": True, "description": "dw-query-gateway 提交响应"},
        "policy_decision": POLICY_DECISION_SCHEMA,
